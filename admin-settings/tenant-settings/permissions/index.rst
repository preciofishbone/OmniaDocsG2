...
Secrets
********
A number of settings will be available under Secrets. Here's an example: 

.. image:: tenant-secrets-new.png

Additional settings may have to be added here depening on installed options in the tenant.
