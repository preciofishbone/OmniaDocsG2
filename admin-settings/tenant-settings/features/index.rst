...
This page describes featueres available in Omnia 6.13 and earlier. For features in Omnia 7.0, see: :doc:`Features (Tenant) in Omnia 7.0 </admin-settings/tenant-settings/features-tenant-7/index>`
