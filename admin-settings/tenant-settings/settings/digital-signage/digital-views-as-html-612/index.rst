...
.. image:: page-view-html-list-612.png
...
+ **Indicator Position**: Available when "Show Indocator" is selected. You can chose to display the Indicator Top Right, Bottom Right, Top Left or Bottom Left.
+ **Slides Indicator Color**: Available when "Show Indocator" is selected. Use this option if you need to change Slides Indicator Color.
+ **Count Down Text Color**: Available when "Show Indocator" is selected. Use this option if you need to change the Count Down Text Color.
