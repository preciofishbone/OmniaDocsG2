...
Single users, Security groups and Microsoft 365 groups can be added here (In Omnia on-prem, Microsoft 365 groups can't be used). A user or a group must be permissions enabled do show up in the list.
