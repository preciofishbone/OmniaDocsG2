...
In Omnia 7.5, Omnia users can be set up for a business profile only, so users the that business profile can be handled by a business profile administrator see: :doc:`User management - business profile </admin-settings/business-group-settings/user-management-bp/index>`
