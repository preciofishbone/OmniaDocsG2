...
For more advice on settings up Intune for Omnia Feed, see this page: :doc:`Setup Intunes for Omnia Feed <//admin-settings/business-group-settings/omnia-feed/setup-intunes-for-omnia-feed/index>`(to add)
