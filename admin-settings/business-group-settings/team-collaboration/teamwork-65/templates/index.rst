...
+ **Clone an existing team**: If the purpose of this template is to make it possible to clone a team, select this option. Note that a colleague must be member of a team fto be able to clown a team.
