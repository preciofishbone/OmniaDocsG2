...
+ **Enable Spelling Suggestions**: Select this option to display spelling suggestions in Advanced Search, when users type in the search field. It's the same functionality that Microsoft 365 has. Must be activated in Omnia Admin for the option to show up.
