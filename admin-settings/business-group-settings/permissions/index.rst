...
+ **Allow mobile login**: This setting is intended to offer login to certain parts of Omnia for first line workers, partners and similar. The user needs the Kaizala app and a viable account. (Mobile login can't be used in Omnia on-prem). In Omnia 6.10 this functionality will be relabeled "Kaizala login".
