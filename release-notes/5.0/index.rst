...
Newsletter
----------------------------------------
- As part of the newsletter feature, it’s now possible to pick explicit pages for display in any page rollup.
...
- Added "normal" Spanish (Español) as a selectable language. 
