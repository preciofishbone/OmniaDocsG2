...
+ **Icon Type**: If you would like an icon to be shown for the block, the first step is the selec icon type. (If you don't salect an icon, Icon Type has no effect.)
