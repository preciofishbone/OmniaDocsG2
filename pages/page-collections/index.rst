...
+ **Enable Scheduling**: If scheduling should be available in this Page Collection, select this option. The author can then set a scheduled start date and time. It's also possible to select a property for scheduling, as an alternative. 
