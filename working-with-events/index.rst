...
On an Event Page it will be possible for colleagues, and even external partners, to register or to be registered for participating in the event, and to cancel registrations, if needed.
