...
App Studio, used in this instruction is being deprecated. You should now use Developer Portal instead. See this page for more information: :doc:`Setup Omni in Microsoft Teams using Developer Studio </setup/setup-omnia-teams-developer-studio/index>`
